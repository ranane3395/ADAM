...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/broad-queen-d224)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/broad-queen-d224
```

A live public deployment of this template is available at [https://broad-queen-d224.templates.workers.dev](https://broad-queen-d224.templates.workers.dev)
